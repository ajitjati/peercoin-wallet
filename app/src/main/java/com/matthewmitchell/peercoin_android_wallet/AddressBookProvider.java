...
public class AddressBookProvider extends ContentProvider
{
	...
	public static Uri contentUri(@NotNull final String packageName)
	{
		return Uri.parse("content://" + packageName + '.' + DATABASE_TABLE);
	}

	public static String resolveLabel(final Context context, @NotNull final String address)
	{
		String label = null;
	...
	private static void appendAddresses(@NotNull final SQLiteQueryBuilder qb, @NotNull final String[] addresses)
	{
