	...
	private final Runnable fetchAndDecodeRunnable = new Runnable()
	{
		...
		private void decode(final byte[] data)
		{
			...
			try
			{
				...
				final int thumbnailWidth = source.getWidth();
				final int thumbnailHeight = source.getHeight();
				...
				thumbnailImage.setPixels(source.renderCroppedGreyscaleBitmap(), 0, thumbnailWidth, 0, 0, thumbnailWidth, thumbnailHeight);
